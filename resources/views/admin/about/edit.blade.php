        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="{{ route('admin.about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-5">
                            <img src="{{asset('storage/identities/'.$about->image)}}" class="admin-edit-image">
                        </div>
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="title" value="{{ old('title', $about->title) }}">
                        @error('title')
