@extends('layouts.app', ['title' => 'Edit benefit Us - Admin'])
...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold capitalize">EDIT benefit </h2>
            <hr class="mt-4">
            <form action="{{ route('admin.benefit.update', $benefit->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-5">
                            <img src="{{asset('storage/benefits/'.$benefit->image)}}" class="admin-edit-image">
                        </div>
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="name" value="{{ old('name', $benefit->name) }}">
                        @error('name')
            ...
            <div>
                ...
                <textarea name="description" rows="15">{{ old('description', $benefit->description) }}</textarea>
                @error('description')
                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                        <div class="px-4 py-2">
                            <p class="text-gray-600 text-sm">{{ $message }}</p>
            ...
            <div>
                ...
                <textarea name="content" rows="15">{{ old('content', $benefit->content) }}</textarea>
                @error('content')
                    <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                        <div class="px-4 py-2">
                            <p class="text-gray-600 text-sm">{{ $message }}</p>
